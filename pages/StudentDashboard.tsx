  ...
  return (
    <div className="p-8 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-[#1e3a8a] text-white p-6 rounded-xl shadow-lg flex flex-col justify-between group cursor-pointer hover:bg-blue-900 transition-all">
          <div>
            ...
            <p className="text-sm opacity-80 mt-2">Check your performance metrics and attendance.</p>
          </div>
        </div>
        <div className="bg-white border-2 border-gray-100 p-6 rounded-xl shadow-lg flex flex-col justify-between group cursor-pointer hover:border-blue-500 transition-all">
          <div>
            <svg className="w-10 h-10 mb-4 text-blue-600 opacity-70" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" /></svg>
            <h3 className="text-xl font-bold text-gray-800">Submit Query</h3>
            <p className="text-sm text-gray-500 mt-2">Ask questions or raise concerns.</p>
          </div>
        </div>
      </div>
    </div>
